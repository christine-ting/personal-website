const portfolioData = {
  ...
  applications: [
    {
      ...
      image:
        'https://ct-my-website.s3-us-west-1.amazonaws.com/Screen+Shot+2020-05-05+at+5.52.11+PM.png',
      description:
    ...
    },
    {
      ...
      image:
        'https://ct-my-website.s3-us-west-1.amazonaws.com/Screen+Shot+2020-05-13+at+5.30.54+PM.png',
      description:
    ...
    },
    {
      ...
      image:
        'https://ct-my-website.s3-us-west-1.amazonaws.com/Screen+Shot+2020-05-13+at+12.19.18+PM.png',
      description:
  ...
  contact:
    'Drop me an e-mail at christineting.an@gmail.com or simply fill out the form below and I will reply to you soon!'
};
  ...
  education: [
    {
      ...
      degree:
        'Bachelor of Arts in Double Major: Applied Mathematics and Economics',
  ...
  others: [
    {
      category: 'Leadership',
      details:
        'Social Chair, Tau Omega Pi Entrepreneurship Fraternity, Berkeley, CA (January–May 2013).'
    },
    {
      category: 'Languages',
      details:
        'Chinese Mandarin (native), English (fluent), Spanish (proficient).'
    },
    {
      category: 'Leadership',
      details:
        'Wine & Spirit Education Trust (WSET) Level 1, Professional Association of Diving Instructors (PADI) Open Water Certificate.'
    }
  ]
};
