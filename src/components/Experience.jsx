  ...
  <div className="experience">
    <div className="job">
      ...
      <div className="role-duration">
        <div>
          Software Engineering Technical Teaching Assistant
        </div>
        <div>
          March 2020 - Present
        </div>
    ...
    <div className="job">
      ...
      <div className="job-details">
        <p>
          &#9675;&nbsp;Prepare and execute comprehensive technical review sessions for junior-phase software engineering students; the cohort resulted in approximately 50% increase in passing rate compared to the previous cohort.Monitored competitor’s new products and pricing techniques and responded with corrective actions.
        </p>
        <p>
